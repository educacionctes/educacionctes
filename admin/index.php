...
//Application Title
define('APP_TITLE', 'Contenidos Educativos Corrientes');
...
$auth_users = array(
    'admin' => '$2y$10$MNwgQ34DECF4W20ajzp1Bum/fkh79VZE6IBXs.fy58G15USZ7K5dW', //m3c.2020
...
$favicon_path = 'https://www.corrientes.gob.ar/assets/favicon-395536e51a828bff17dac3fdab965fd8.ico';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array(
        'admin','assets','views','options.php','scripts.js','style.css','index.php'
);
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                           <img src="../assets/ctes-logo.png" alt="" class="ctes-logo">
                                        </div>
                                        <div class="text-center">
                                            <h1 class="card-title"><b><?php echo APP_TITLE; ?></b></h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Contenidos Educativos';      $tr['en']['AppTitle']           = 'File Manager';
